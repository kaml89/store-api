...
var UserService = __importStar(require("../users/user.service"));
var bcrypt_1 = __importDefault(require("bcrypt"));
var utils_1 = require("../utils/utils");
exports.default = {
    signup: function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, email, password, name_1, role, existingUser, newUser, savedUser, userInfo, err_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 3, , 4]);
                    _a = req.body, email = _a.email, password = _a.password, name_1 = _a.name, role = _a.role;
                    return [4 /*yield*/, UserService.getByEmail(email)];
                case 1:
                    ...
                    return [4 /*yield*/, UserService.create(newUser)];
                case 2:
                    savedUser = _b.sent();
                    userInfo = {
                        name: savedUser.name,
    ...
    login: function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, email, password, user, isPasswordCorrect, token, responseObject, err_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 3, , 4]);
